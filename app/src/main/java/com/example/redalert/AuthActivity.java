        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (enteredCode.equals(secretCode)) {
                    ...
                    Toast.makeText(AuthActivity.this, "You are a authorised user !", Toast.LENGTH_SHORT).show();
                } else {
                    // Code is incorrect, show an error message
                    Toast.makeText(AuthActivity.this, "Incorrect code. Try again.", Toast.LENGTH_SHORT).show();
                }
            }
        });
